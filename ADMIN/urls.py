...
urlpatterns = [
	...
	path('admin_delete_personnel/<int:pk>/', views.admin_delete_personnel, name='admin_delete_personnel'),
	path('admin_edit_personnel/<int:pk>/', views.admin_edit_personnel, name='admin_edit_personnel'),
