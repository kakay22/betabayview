...
from ADMIN.models import Secretary, Event, Comment, Property, Message, MaintenancePersonnel, Log, PropertyImage, Announcement, AnnouncementComment, PaymentReminder
