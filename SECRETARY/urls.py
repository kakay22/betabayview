...
urlpatterns = [
	...
	path('sec_delete_personnel/<int:pk>/', views.sec_delete_personnel, name='sec_delete_personnel'),
	path('sec_edit_personnel/<int:pk>/', views.sec_edit_personnel, name='sec_edit_personnel'),
